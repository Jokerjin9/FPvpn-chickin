...
def Chickin():
    ...
    time.sleep(2)     
    driver.find_element('xpath', '//*[@id="username_LZpVQ"]').send_keys(username)
    time.sleep(2)
    driver.find_element('xpath', '//*[@id="password3_LZpVQ"]').send_keys(password)
    time.sleep(2)                  
    driver.find_element('xpath', '//*[@id="loginform_LZpVQ"]/div/div[6]/button').click()
    time.sleep(5)
    #chickin
    try:                                                
        driver.find_element('xpath', '//*[@id="JD_sign"]').click()
